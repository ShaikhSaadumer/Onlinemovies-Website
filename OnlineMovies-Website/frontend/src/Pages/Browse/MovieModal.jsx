    ...
    <>
      <Box className={styles.reactplayer}>
        <iframe
          ...
          title="hello"
          height="576"
          src={`https://www.youtube.com/embed/${Movie.video}?autoplay=1&showinfo=0&controls=0&mute=1&rel=0`}
          frameBorder="0"
          autoPlay="1"
        ...
        <div className={styles.video__info}>
          <div className={styles.synopsis}>
            <button
              ...
              onClick={() => history.push(`/video/${Movie.video}`)}
            >
            ...
            <div className={styles.synopsis_tooltips}>
              {inList ? (
                ...
                >
                  <AddIcon
                    onClick={() => handleAddToList(Movie._id)}
        ...
        <div className={styles.movie_info}>
          <div className={styles.movie_info_left}>
            <div className={styles.movie_info_left__first}>
              <p className={styles.movie_info_left__first_green}>{`${
            ...
            <div>
              ...
              {Movie.genre_ids.length !== 0 &&
                Movie.genre_ids.map((genre, i) => {
                  return (
                    <span
                      className={styles.movie_info_right_links}
                      key={genre._id}
                    >
                      {genre.name}
                      {`${Movie.genre_ids.length - 1 !== i ? "," : ""}`}
                    </span>
                  );
                })}
            </div>
